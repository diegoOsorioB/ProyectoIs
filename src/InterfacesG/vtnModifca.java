 ...
 * @author diego
 */
public class vtnModifca extends javax.swing.JFrame
{  FondoPanel fondo=new FondoPanel();
    ...
    public static void main(String args[])
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vtnModifca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new vtnModifca().setVisible(true);
            }
        });
    }
